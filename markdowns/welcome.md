...
@[Luke, how many stars are there in these galaxies?]({"stubs": ["src/Exercises/Universe.cpp", "src/Exercises/Universe.h", "src/UniverseTest.cpp", "run.sh"],"command": "/project/target/run.sh"})
